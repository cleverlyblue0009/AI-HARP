...
#: 6: the exit-only bottleneck gave 40.7 veh/km/lane at 48 km/h; the whole
#:    congested corridor is now limited to v_eq with inflow k * v_eq inserted
#:    at v_eq.
